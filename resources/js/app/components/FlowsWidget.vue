<template lang="html">
  ...
  >
    ...
    >
      <div class="flows-widget" v-if="opened_flows">
        <router-link class="item" to="/flows">Discharge</router-link>
      </div>
    </transition>
    <button
      class="pop-btn"
      @click="opened_flows = !opened_flows"
      v-bind:class="{ active: opened_flows }"
    >
